                ...
                <form id="FRM_INSERT_PROVEEDOR" method="post" action="<?php echo $functions->direct_sistema(); ?>/modules/proveedores/insert-update-proveedor.php" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="card-title">Datos de proveedor</div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        placeholder="Ingese RTU / DPI" required>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Razón Social / Nombre</label>
                                        <input type="text" class="form-control" placeholder="Ingrese razón social / Nombre" name="proveedor_razsoc" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Zona</label>
                                        <input type="text" class="form-control" placeholder="Ingrese Zona" name="proveedor_distrito" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
