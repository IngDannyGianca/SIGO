            ...
            <div class="row mb-0">
                <div class="col-md-12">
                    <div class="m-0 text-dark text-center text-lg">
                        <i class="fas fa-box"></i>&nbsp;&nbsp;Actualizar Stock de un activo
                    </div>
                </div>
            </div>
        </div>
                ...
                <form id="FRM_INSERT_MOV" method="post" action="<?php echo $functions->direct_sistema(); ?>/modules/productos/insert-movimiento-stock.php" enctype="multipart/form-data">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="card-title">Datos del movimiento de activo</div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="rbtnIngreso" class="custom-control-label">Ingreso Activo</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="mov_tipo" id="rbtnAjuste" value="Ajuste">
                                            <label for="rbtnAjuste" class="custom-control-label">Ajuste activo</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-10">
                            ...
                            <div id="mov_secondary_info" class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Fecha ingreso activo</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="float-right">
                                <button type="submit" id="btn-save-product" class="btn btn-success btn-md"><i class="fa fa-save fa-1x"></i>&nbsp;&nbsp;<font>Actualizar activo</font></button>
                            </div>
                        </div>
                    </div>
                </form>
