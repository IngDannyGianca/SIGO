  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $functions->direct_paginas()."home" ?>" class="brand-link">
      <img src="<?php echo $functions->direct_sistema(); ?>/img/chemistry.png" alt="DuoLab Group Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-dark text-cyan"><strong>SIGO</strong> GT</span>
    </a>
...
<li class="nav-item has-treeview menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a id="m_registro_producto" href="<?php echo $functions->direct_paginas()."propiedad/registro-producto" ?>" class="nav-link">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Registro de activo</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="m_listado_producto" href="<?php echo $functions->direct_paginas()."propiedad/listado-producto" ?>" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
                  <p>Listado de Activos</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="m_actualizar_stock" href="<?php echo $functions->direct_paginas()."propiedad/actualizar-stock" ?>" class="nav-link">
                  <i class="nav-icon far fa-circle text-warning"></i>
                  <p>Actualizar Stock</p>
                </a>
              </li>
              <li class="nav-item">
                <a id="m_historial_movimiento" href="<?php echo $functions->direct_paginas()."propiedad/historial-movimiento" ?>" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
